      ...
      prevPlayers.map((player) => {
        ...
        matches.forEach((m) => {
          ...
          if (draw) {
            ...
            if (m.playerA.id === player.id) roundPoints += 2;
            if (m.playerB.id === player.id && m.scoreB === 1) roundPoints += 2;
          } else {
            if (m.playerB.id === player.id) roundPoints += 2;
            if (m.playerA.id === player.id && m.scoreA === 1) roundPoints += 2;
          }
        });
